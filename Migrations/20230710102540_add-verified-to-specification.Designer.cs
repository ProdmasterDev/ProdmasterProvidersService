...
namespace ProdmasterProvidersService.Migrations
{
    ...
    [Migration("20230710102540_add-verified-to-specification")]
    partial class addverifiedtospecification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProdmasterProvidersService.Database.Models.Product", b =>
                {
                    ...
                    b.HasOne("ProdmasterProvidersService.Database.Models.Specification", null)
                        .WithMany("Products")
